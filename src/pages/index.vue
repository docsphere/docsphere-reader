<template>
  <q-page-container>
    <q-page id="content" class="q-pa-lg">
      ...
      <h3>Source code highlighted in i18n files</h3>
      <p>This documentation generates codes with Syntax highlighting from codes with multiline and line indented stored in translatable i18n files. So you can access the codes of the documentation <b>offline</b> and we can also use i18n for example to translate code comments.</p>
