<template>
  <d-page :nodes="nodes">
    ...
    <d-page-code>
      ...
      <tr>
        <td id="file-code4-vue-L2" class="blob-num js-line-number" data-line-number="2"></td>
        <td id="file-code4-vue-LC2" class="blob-code blob-code-inner js-file-line">&lt;<span class="pl-ent">div</span>&nbsp;<span class="pl-e">v-touch-swipe</span>=<span class="pl-s1"><span class="pl-pds">"</span>handler<span class="pl-pds">"</span></span>&gt;...&lt;/<span class="pl-ent">div</span>&gt;</td>
      </tr>
      <tr>
